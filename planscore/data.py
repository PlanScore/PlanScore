...
MODELS = [
    ...
    Model(State.AK, House.ushouse,       1,  True, VERSIONS, 'data/AK/009-cvap-2023'), # nnnnnnn
    ...
    Model(State.ID, House.ushouse,       2,  True, VERSIONS, 'data/ID/009-cvap-2023'), # nnnnnnn
    ...
    Model(State.MI, House.ushouse,      13,  True, VERSIONS, 'data/MI/012-cvap-2023'), # nnnnnnn
    ...
    Model(State.ND, House.ushouse,       1,  True, VERSIONS, 'data/ND/012-cvap-2023'), # nnnnnnn
    ...
    Model(State.NJ, House.ushouse,      12,  True, VERSIONS, 'data/NJ/008-cvap-2023'), # nnnnnnn
    ...
    Model(State.OK, House.ushouse,       5,  True, VERSIONS, 'data/OK/009-cvap-2023'), # nnnnnnn
    ...
    Model(State.OR, House.ushouse,       6,  True, VERSIONS, 'data/OR/009-cvap-2023'), # nnnnnnn
    ...
    Model(State.SD, House.ushouse,       1,  True, VERSIONS, 'data/SD/009-cvap-2023'), # nnnnnnn
    ...
    Model(State.VT, House.ushouse,       1,  True, VERSIONS, 'data/VT/011-cvap-2023'), # nnnnnnn
