...
MODELS = [
    ...
    Model(State.RI, House.ushouse,       2,  True, VERSIONS, 'data/RI/012-more-acs'), # 48bf006
    Model(State.RI, House.statesenate,  38,  True, VERSIONS, 'data/RI/012-more-acs'), # 48bf006
    Model(State.RI, House.statehouse,   75,  True, VERSIONS, 'data/RI/012-more-acs'), # 48bf006
    Model(State.RI, House.localplan,  None,  True, VERSIONS, 'data/RI/012-more-acs'), # 48bf006
