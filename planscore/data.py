...
MODELS2020 = [
    ...
    Model(State.NC, House.ushouse,      13,  True, '2020', 'data/NC/011-festblocks'), # c12cba3
    Model(State.NC, House.statesenate,  50,  True, '2020', 'data/NC/011-festblocks'), # c12cba3
    Model(State.NC, House.statehouse,  120,  True, '2020', 'data/NC/011-festblocks'), # c12cba3
