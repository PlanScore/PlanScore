...
MODELS = [
    ...
    Model(State.AK, House.ushouse,       1,  True, VERSION, 'data/AK/003-decennial'), # ce0e094
    Model(State.AK, House.statesenate,  20,  True, VERSION, 'data/AK/003-decennial'), # ce0e094
    Model(State.AK, House.statehouse,   40,  True, VERSION, 'data/AK/003-decennial'), # ce0e094
    ...
    Model(State.DE, House.ushouse,       1,  True, VERSION, 'data/DE/005-decennial'), # ce0e094
    Model(State.DE, House.statesenate,  21,  True, VERSION, 'data/DE/005-decennial'), # ce0e094
    Model(State.DE, House.statehouse,   41,  True, VERSION, 'data/DE/005-decennial'), # ce0e094
    ...
    Model(State.HI, House.ushouse,       2,  True, VERSION, 'data/HI/003-decennial'), # ce0e094
    Model(State.HI, House.statesenate,  25,  True, VERSION, 'data/HI/003-decennial'), # ce0e094
    Model(State.HI, House.statehouse,   51,  True, VERSION, 'data/HI/003-decennial'), # ce0e094
    ...
    Model(State.NH, House.ushouse,       2,  True, VERSION, 'data/NH/005-decennial'), # ce0e094
    Model(State.NH, House.statesenate,  24,  True, VERSION, 'data/NH/005-decennial'), # ce0e094
    Model(State.NH, House.statehouse,  400,  True, VERSION, 'data/NH/005-decennial'), # ce0e094
    ...
    Model(State.RI, House.ushouse,       2,  True, VERSION, 'data/RI/006-decennial'), # 31e3626
    Model(State.RI, House.statesenate,  38,  True, VERSION, 'data/RI/006-decennial'), # 31e3626
    Model(State.RI, House.statehouse,   75,  True, VERSION, 'data/RI/006-decennial'), # 31e3626
    ...
    Model(State.VT, House.ushouse,       1,  True, VERSION, 'data/VT/005-decennial'), # ce0e094
    Model(State.VT, House.statesenate,  30,  True, VERSION, 'data/VT/005-decennial'), # ce0e094
    Model(State.VT, House.statehouse,  150,  True, VERSION, 'data/VT/005-decennial'), # ce0e094
