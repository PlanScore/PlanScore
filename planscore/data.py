...
MODELS = [
    ...
    Model(State.AK, House.statesenate,  20,  True, VERSIONS_20_24B, 'data/AK/010-pvote-2024'), # 6bacc75
    Model(State.AK, House.statehouse,   40,  True, VERSIONS_20_24B, 'data/AK/010-pvote-2024'), # 6bacc75
    ...
    Model(State.OK, House.statesenate,  48,  True, VERSIONS_16_20_24B, 'data/OK/010-pvote-2024'), # 6bacc75
    Model(State.OK, House.statehouse,  101,  True, VERSIONS_16_20_24B, 'data/OK/010-pvote-2024'), # 6bacc75
    ...
    Model(State.SD, House.statesenate,  35,  True, VERSIONS_16_20_24B, 'data/SD/010-pvote-2024'), # 6bacc75
    Model(State.SD, House.statehouse,   70,  True, VERSIONS_16_20_24B, 'data/SD/010-pvote-2024'), # 6bacc75
