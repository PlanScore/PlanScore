...
MODELS = [
    ...
    Model(State.CO, House.ushouse,       7,  True, VERSION, 'data/CO/007-decennial'), # 3d7408d
    Model(State.CO, House.statesenate,  35,  True, VERSION, 'data/CO/007-decennial'), # 3d7408d
    Model(State.CO, House.statehouse,   65,  True, VERSION, 'data/CO/007-decennial'), # 3d7408d
