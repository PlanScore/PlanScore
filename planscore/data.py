...
MODELS = [
    ...
    Model(State.AL, House.statesenate,  35,  True, VERSIONS_16_20_24A, 'data/AL/008-acs-2020'), # c82db89
    Model(State.AL, House.statehouse,  105,  True, VERSIONS_16_20_24A, 'data/AL/008-acs-2020'), # c82db89
    ...
    Model(State.AR, House.statesenate,  35,  True, VERSIONS_16_20_24A, 'data/AR/008-acs-2020'), # c82db89
    Model(State.AR, House.statehouse,  100,  True, VERSIONS_16_20_24A, 'data/AR/008-acs-2020'), # c82db89
    ...
    Model(State.CT, House.statesenate,  36,  True, VERSIONS_16_20_24A, 'data/CT/006-acs-2020'), # c82db89
    Model(State.CT, House.statehouse,  151,  True, VERSIONS_16_20_24A, 'data/CT/006-acs-2020'), # c82db89
    ...
    Model(State.DE, House.statesenate,  21,  True, VERSIONS_16_20_24A, 'data/DE/010-acs-2020'), # c82db89
    Model(State.DE, House.statehouse,   41,  True, VERSIONS_16_20_24A, 'data/DE/010-acs-2020'), # c82db89
    ...
    Model(State.FL, House.statesenate,  40,  True, VERSIONS_16_20_24A, 'data/FL/010-acs-2020'), # c82db89
    Model(State.FL, House.statehouse,  120,  True, VERSIONS_16_20_24A, 'data/FL/010-acs-2020'), # c82db89
    ...
    Model(State.GA, House.statesenate,  56,  True, VERSIONS_16_20_24A, 'data/GA/012-acs-2020'), # c82db89
    Model(State.GA, House.statehouse,  180,  True, VERSIONS_16_20_24A, 'data/GA/012-acs-2020'), # c82db89
    ...
    Model(State.HI, House.statesenate,  25,  True, VERSIONS_16_20_24A, 'data/HI/008-acs-2020'), # c82db89
    Model(State.HI, House.statehouse,   51,  True, VERSIONS_16_20_24A, 'data/HI/008-acs-2020'), # c82db89
    ...
    Model(State.IL, House.statesenate,  59,  True, VERSIONS_16_20_24A, 'data/IL/010-acs-2020'), # c82db89
    Model(State.IL, House.statehouse,  118,  True, VERSIONS_16_20_24A, 'data/IL/010-acs-2020'), # c82db89
    ...
    Model(State.IN, House.statesenate,  50,  True, VERSIONS_16_20_24A, 'data/IN/009-acs-2020'), # c82db89
    Model(State.IN, House.statehouse,  100,  True, VERSIONS_16_20_24A, 'data/IN/009-acs-2020'), # c82db89
    ...
    Model(State.KS, House.statesenate,  40,  True, VERSIONS_16_20_24A, 'data/KS/009-acs-2020'), # c82db89
    Model(State.KS, House.statehouse,  125,  True, VERSIONS_16_20_24A, 'data/KS/009-acs-2020'), # c82db89
    ...
    Model(State.KY, House.statesenate,  38,  True, VERSIONS_16_20_24A, 'data/KY/007-acs-2020'), # c82db89
    Model(State.KY, House.statehouse,  100,  True, VERSIONS_16_20_24A, 'data/KY/007-acs-2020'), # c82db89
    ...
    Model(State.LA, House.statesenate,  39,  True, VERSIONS_16_20_24A, 'data/LA/007-acs-2020'), # c82db89
    Model(State.LA, House.statehouse,  105,  True, VERSIONS_16_20_24A, 'data/LA/007-acs-2020'), # c82db89
    ...
    Model(State.MA, House.statesenate,  40,  True, VERSIONS_16_20_24A, 'data/MA/010-acs-2020'), # c82db89
    Model(State.MA, House.statehouse,  160,  True, VERSIONS_16_20_24A, 'data/MA/010-acs-2020'), # c82db89
    ...
    Model(State.MD, House.statesenate,  47,  True, VERSIONS_16_20_24A, 'data/MD/012-acs-2020'), # c82db89
    Model(State.MD, House.statehouse,   68,  True, VERSIONS_16_20_24A, 'data/MD/012-acs-2020'), # c82db89
    ...
    Model(State.MN, House.statesenate,  67,  True, VERSIONS_16_20_24A, 'data/MN/010-acs-2020'), # c82db89
    Model(State.MN, House.statehouse,  134,  True, VERSIONS_16_20_24A, 'data/MN/010-acs-2020'), # c82db89
    ...
    Model(State.MO, House.statesenate,  34,  True, VERSIONS_16_20_24A, 'data/MO/009-acs-2020'), # c82db89
    Model(State.MO, House.statehouse,  163,  True, VERSIONS_16_20_24A, 'data/MO/009-acs-2020'), # c82db89
    ...
    Model(State.MS, House.statesenate,  52,  True, VERSIONS_16_20_24A, 'data/MS/004-acs-2020'), # c82db89
    Model(State.MS, House.statehouse,  122,  True, VERSIONS_16_20_24A, 'data/MS/004-acs-2020'), # c82db89
    ...
    Model(State.MT, House.statesenate,  50,  True, VERSIONS_16_20_24A, 'data/MT/010-acs-2020'), # c82db89
    ...
    Model(State.NE, House.statesenate,  49,  True, VERSIONS_16_20_24A, 'data/NE/008-acs-2020'), # c82db89
    Model(State.NE, House.localplan,  None,  True, VERSIONS_16_20_24A, 'data/NE/008-acs-2020'), # c82db89
    ...
    Model(State.NM, House.statesenate,  42,  True, VERSIONS_16_20_24A, 'data/NM/008-acs-2020'), # c82db89
    Model(State.NM, House.statehouse,   70,  True, VERSIONS_16_20_24A, 'data/NM/008-acs-2020'), # c82db89
    ...
    Model(State.NV, House.statesenate,  21,  True, VERSIONS_16_20_24A, 'data/NV/008-acs-2020'), # c82db89
    Model(State.NV, House.statehouse,   42,  True, VERSIONS_16_20_24A, 'data/NV/008-acs-2020'), # c82db89
    ...
    Model(State.NY, House.statesenate,  63,  True, VERSIONS_16_20_24A, 'data/NY/003-acs-2020'), # c82db89
    Model(State.NY, House.statehouse,  150,  True, VERSIONS_16_20_24A, 'data/NY/003-acs-2020'), # c82db89
    ...
    Model(State.OR, House.ushouse,       6,  True, VERSIONS_16_20_24A, 'data/OR/009-cvap-2023'), # d4b3c7d
    Model(State.OR, House.statesenate,  30,  True, VERSIONS_16_20_24A, 'data/OR/008-acs-2020'), # c82db89
    ...
    Model(State.PA, House.statesenate,  50,  True, VERSIONS_16_20_24A, 'data/PA/019-acs-2020'), # c82db89
    Model(State.PA, House.statehouse,  203,  True, VERSIONS_16_20_24A, 'data/PA/019-acs-2020'), # c82db89
    ...
    Model(State.RI, House.statesenate,  38,  True, VERSIONS_16_20_24A, 'data/RI/015-acs-2020'), # c82db89
    Model(State.RI, House.statehouse,   75,  True, VERSIONS_16_20_24A, 'data/RI/015-acs-2020'), # c82db89
    ...
    Model(State.TN, House.statesenate,  33,  True, VERSIONS_20_24A, 'data/TN/009-acs-2020'), # c82db89
    Model(State.TN, House.statehouse,   99,  True, VERSIONS_20_24A, 'data/TN/009-acs-2020'), # c82db89
    ...
    Model(State.TX, House.statesenate,  31,  True, VERSIONS_16_20_24A, 'data/TX/010-acs-2020'), # c82db89
    Model(State.TX, House.statehouse,  150,  True, VERSIONS_16_20_24A, 'data/TX/010-acs-2020'), # c82db89
    ...
    Model(State.UT, House.statesenate,  29,  True, VERSIONS_16_20_24A, 'data/UT/008-acs-2020'), # c82db89
    Model(State.UT, House.statehouse,   75,  True, VERSIONS_16_20_24A, 'data/UT/008-acs-2020'), # c82db89
    ...
    Model(State.WA, House.statesenate,  49,  True, VERSIONS_16_20_24A, 'data/WA/009-acs-2020'), # c82db89
    Model(State.WA, House.statehouse,   98,  True, VERSIONS_16_20_24A, 'data/WA/009-acs-2020'), # c82db89
    ...
    Model(State.WI, House.statesenate,  33,  True, VERSIONS_16_20_24A, 'data/WI/014-acs-2020'), # c82db89
    Model(State.WI, House.statehouse,   99,  True, VERSIONS_16_20_24A, 'data/WI/014-acs-2020'), # c82db89
    ...
    Model(State.WV, House.statesenate,  34,  True, VERSIONS_16_20_24A, 'data/WV/004-acs-2020'), # c82db89
    Model(State.WV, House.statehouse,  100,  True, VERSIONS_16_20_24A, 'data/WV/004-acs-2020'), # c82db89
    ...
    Model(State.WY, House.statesenate,  30,  True, VERSIONS_16_20_24A, 'data/WY/010-acs-2020'), # c82db89
    Model(State.WY, House.statehouse,   60,  True, VERSIONS_16_20_24A, 'data/WY/010-acs-2020'), # c82db89
