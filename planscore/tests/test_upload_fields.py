...
class TestUploadFields (unittest.TestCase):
    ...
    def test_build_api_base(self):
        ...
        assert upload_fields.build_api_base(request1) == 'https://api.dev.planscore.org/'
        ...
        assert upload_fields.build_api_base(request2) == 'https://8vfhwtrj53.execute-api.us-east-1.amazonaws.com/prod/'
