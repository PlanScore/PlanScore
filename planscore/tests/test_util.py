...
class TestUtil (unittest.TestCase):
    ...
    def test_baf_stream_to_rows(self):
        ...
        fields1, rows1 = util.baf_stream_to_rows(open(null_plan1_path))
        ...
        fields2, rows2 = util.baf_stream_to_rows(open(null_plan2_path))
        ...
        fields3, rows3 = util.baf_stream_to_rows(open(null_plan3_path))
        ...
        fields4, rows4 = util.baf_stream_to_rows(open(null_plan4_path))
        ...
        fields5, rows5 = util.baf_stream_to_rows(open(null_plan5_path))
        ...
        fields6, rows6 = util.baf_stream_to_rows(open(null_plan6_path))
        ...
        fields7, rows7 = util.baf_stream_to_rows(open(null_plan7_path))
        ...
        fields8, rows8 = util.baf_stream_to_rows(open(null_plan8_path))
        ...
        fields9, rows9 = util.baf_stream_to_rows(open(null_plan9_path))
        ...
        fields10, rows10 = util.baf_stream_to_rows(open(null_plan10_path))
