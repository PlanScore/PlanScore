...
class TestPrereadFollowup (unittest.TestCase):
    ...
    def test_guess_state_model_knowns(self):
        ...
        self.assertEqual(preread_followup.guess_state_model(null_plan_path).key_prefix, 'data/XX/006-blocks')
    ...
    def test_guess_state_model_imagined(self, osgeo_ogr):
        ...
        self.assertEqual(preread_followup.guess_state_model('districts.shp').key_prefix, 'data/XX/006-blocks')
        ...
        self.assertEqual(preread_followup.guess_state_model('districts.shp').key_prefix, 'data/NC/014-festblocks')
    ...
    def test_commence_upload_parsing_good_file(self, guess_state_model, count_district_geometries, put_upload_index, temporary_buffer_file):
        ...
        guess_state_model.return_value = data.Model(data.State.XX, None, 2, True, '2020', 'data/XX/006-blocks')
        ...
        self.assertEqual(put_upload_index.mock_calls[0][1][1].message,
            'Found 2 districts in the "data/XX/006-blocks" None plan with 2 seats.')
