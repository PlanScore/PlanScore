...
class TestRunTile (unittest.TestCase):
    ...
    def test_score_district_invalid(self):
        ''' Correct district totals appear despite invalid input geometry
        '''
        ...
        all_totals = [
            run_tile.score_district(feature.GetGeometryRef(), precincts, tile_geom)
            for feature in district_features
        ]
        
        expected_2020 = sum([precinct['properties']['Population 2020'] for precinct in precincts])
        actual_2020 = sum([total['Population 2020'] for total in all_totals])
        
        self.assertEqual(expected_2020, actual_2020, 'Should see all presidental votes exactly once')
    ...
    def test_score_precinct(self):
        ...
        self.assertAlmostEqual(totals['O:REP999'], 1.69067528, places=2)
    ...
    def test_score_precinct_2016_incomes(self):
        ...
        self.assertAlmostEqual(totals['Voters'], 3.381350576, places=2)
        self.assertAlmostEqual(totals['Households 2016'], 1.690675288, places=2)
        self.assertAlmostEqual(totals['Sum Household Income 2016'], 99815.77833, places=2)
        self.assertEqual(totals['Household Income 2016'], 0)
    ...
    def test_score_precinct_2019_incomes(self):
        ...
        totals = collections.defaultdict(int)
        district_geom = osgeo.ogr.CreateGeometryFromWkt('POLYGON ((-0.0002360 0.0004532,-0.0006812 0.0002467,-0.0006356 -0.0003486,-0.0000268 -0.0004693,-0.0000187 -0.0000214,-0.0002360 0.0004532))')
        precinct = {"type": "Feature", "properties": {"GEOID": "3", "NAME": "Precinct 3", "Voters": 6, "Households 2019": 3, "Household Income 2019": 59039, "Household Income 2019, Margin": 5904, "PlanScore:Fraction": 0.563558429345361}, "geometry": {"type": "Polygon", "coordinates": [[[-0.0003853, 0.0], [-0.0003819, 2.5e-06], [-0.0003824, 1.16e-05], [-0.0003895, 1.16e-05], [-0.000391, 1.47e-05], [-0.0003922, 2.1e-05], [-0.0003832, 3.27e-05], [-0.0003844, 3.81e-05], [-0.0003751, 5.2e-05], [-0.0003683, 5.48e-05], [-0.0003685, 5.99e-05], [-0.0003642, 6.45e-05], [-0.0003597, 6.45e-05], [-0.0003531, 6.45e-05], [-0.0003432, 6.91e-05], [-0.0003379, 6.96e-05], [-0.0003321, 7.06e-05], [-0.0003273, 7.72e-05], [-0.0003268, 8.46e-05], [-0.0003185, 8.97e-05], [-0.0003109, 9.04e-05], [-0.0003064, 9.5e-05], [-0.0002973, 9.45e-05], [-0.0002978, 0.0001047], [-0.0002887, 0.0001103], [-0.0002826, 0.0001067], [-0.0002746, 0.0001042], [-0.0002756, 0.0001164], [-0.0002852, 0.0001179], [-0.0002852, 0.0001245], [-0.0002776, 0.0001291], [-0.0002776, 0.0001438], [-0.0002756, 0.0001464], [-0.00027, 0.0001474], [-0.0002644, 0.0001606], [-0.0002619, 0.0001657], [-0.0002518, 0.0001632], [-0.0002463, 0.0001738], [-0.0002397, 0.0001728], [-0.0002286, 0.0001815], [-0.0002225, 0.0001815], [-0.0002205, 0.0001922], [-0.0002154, 0.0001947], [-0.0002114, 0.0002049], [-0.0001973, 0.0002166], [-0.0001952, 0.0002237], [-0.0001811, 0.0002181], [-0.0001821, 0.000213], [-0.0001882, 0.0002038], [-0.0001856, 0.0001988], [-0.0001856, 0.0001942], [-0.0001882, 0.000184], [-0.0001826, 0.000184], [-0.000176, 0.0001749], [-0.0001715, 0.0001754], [-0.0001634, 0.0001866], [-0.0001594, 0.0001876], [-0.0001538, 0.0001916], [-0.0001478, 0.0001855], [-0.0001382, 0.0001922], [-0.0001255, 0.0001906], [-0.000125, 0.000183], [-0.000118, 0.0001825], [-0.0001175, 0.0001898], [-3.16e-05, 0.0], [-0.0003853, 0.0]]]}}
        ...
        self.assertAlmostEqual(totals['Voters'], 3.381350576, places=2)
        self.assertAlmostEqual(totals['Households 2019'], 1.690675288, places=2)
        self.assertAlmostEqual(totals['Sum Household Income 2019'], 99815.77833, places=2)
        self.assertAlmostEqual(totals['Sum Household Income 2019, Margin'], 9981.75, places=2)
    ...
    def test_score_precinct_incomplete_incomes(self):
        ...
        self.assertAlmostEqual(totals['Voters'], 3.381350576, places=2)
        self.assertAlmostEqual(totals['Households 2016'], 0, places=2)
        self.assertAlmostEqual(totals['Sum Household Income 2016'], 0, places=2)
        self.assertEqual(totals['Household Income 2016'], 0)
