...
class TestMatrix (unittest.TestCase):
    ...
    def test_load_model(self):
        ...
        self.assertAlmostEqual(model.c_matrix[0,0], 0.4761)
        self.assertAlmostEqual(model.c_matrix[1,0], 0.9330)
        self.assertAlmostEqual(model.c_matrix[2,0], 0.0272)
        self.assertAlmostEqual(model.c_matrix[3,0], 0.0070)
        self.assertAlmostEqual(model.c_matrix[4,0], -0.0407)
        self.assertAlmostEqual(model.c_matrix[5,0], -0.0010)
