...
def score_precinct(partial_district_geom, precinct_feat, tile_geom):
    ...
    for name in list(totals.keys()):
        ...
        if name == 'Household Income 2019' and 'Households 2019' in precinct_feat['properties']:
            # Household income can't be summed up like populations,
            # and needs to be weighted by number of households.
        ...
        if name == 'Household Income 2019, Margin' and 'Households 2019' in precinct_feat['properties']:
            # Household income can't be summed up like populations,
            # and needs to be weighted by number of households.
            precinct_value *= (precinct_feat['properties']['Households 2019'] or 0)
