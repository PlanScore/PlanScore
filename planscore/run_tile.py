...
def score_precinct(partial_district_geom, precinct_feat, tile_geom):
    ...
    for name in list(totals.keys()):
        ...
        elif name == 'Household Income 2019' and 'Households 2019' in precinct_feat['properties']:
            precinct_value *= (precinct_feat['properties']['Households 2019'] or 0)
            totals['Sum Household Income 2019'] = \
                round(totals.get('Sum Household Income 2019', 0)
                    + precinct_value, constants.ROUND_COUNT)
        elif name == 'Household Income 2019, Margin' and 'Households 2019' in precinct_feat['properties']:
            precinct_value *= (precinct_feat['properties']['Households 2019'] or 0)
