        ...
        blocks_table = aws_glue.Table(
            ...
            columns=[
                ...
                for (t, n) in [
                    ...
                    (aws_glue.Schema.DOUBLE, "US President 2024 - DEM"),
                    (aws_glue.Schema.DOUBLE, "US President 2024 - REP"),
                    (aws_glue.Schema.DOUBLE, "US President 2024 - Other"),
                    ...
                    (aws_glue.Schema.DOUBLE, "US Senate 2024 - DEM"),
                    (aws_glue.Schema.DOUBLE, "US Senate 2024 - REP"),
                    (aws_glue.Schema.DOUBLE, "US Senate 2024 - Other"),
                    (aws_glue.Schema.DOUBLE, "US Senate 2022 - DEM"),
                    (aws_glue.Schema.DOUBLE, "US Senate 2022 - REP"),
                    (aws_glue.Schema.DOUBLE, "US Senate 2022 - Other"),
                    ...
                    (aws_glue.Schema.DOUBLE, "Citizen Voting-Age Population 2023 ACS"),
                    (aws_glue.Schema.DOUBLE, "Citizen Voting-Age Population 2023 ACS, Margin"),
                    (aws_glue.Schema.DOUBLE, "Black Citizen Voting-Age Population 2023 ACS"),
                    (aws_glue.Schema.DOUBLE, "Black Citizen Voting-Age Population 2023 ACS, Margin"),
                    (aws_glue.Schema.DOUBLE, "Asian Citizen Voting-Age Population 2023 ACS"),
                    (aws_glue.Schema.DOUBLE, "Asian Citizen Voting-Age Population 2023 ACS, Margin"),
                    (aws_glue.Schema.DOUBLE, "American Indian or Alaska Native Citizen Voting-Age Population 2023 ACS"),
                    (aws_glue.Schema.DOUBLE, "American Indian or Alaska Native Citizen Voting-Age Population 2023 ACS, Margin"),
                    (aws_glue.Schema.DOUBLE, "Hispanic Citizen Voting-Age Population 2023 ACS"),
                    (aws_glue.Schema.DOUBLE, "Hispanic Citizen Voting-Age Population 2023 ACS, Margin"),
